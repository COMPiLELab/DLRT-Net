...
from models_folder.vgg import VGG,VGG_types
import torch
...
parser.add_argument('--net_name', type=str, default='vgg_tiny_imagenet_', metavar='NET_NAME',
...
# === dataset object === # 
train_dataset = datasets.ImageFolder(   root= './data/tiny_imagenet/train',
                                        transform= train_T, 
                                    )
# test_dataset = datasets.ImageFolder(    root= "./data/tiny_imagenet/val", 
#                                         transform= test_T,
#                                     ) 
validation_dataset = datasets.ImageFolder(    root= "./data/tiny_imagenet/val", 
                                        transform= test_T,
                                    ) 
